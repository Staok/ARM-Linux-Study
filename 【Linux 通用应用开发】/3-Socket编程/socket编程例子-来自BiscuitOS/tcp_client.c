...
<html lang='zh-CN'>
<head>
<title>bus/net/socket/app/tcp/tcp_client.c · BiscuitOS/HardStack - Gitee.com</title>
...
<meta content='https://gitee.com/BiscuitOS_team/HardStack/blob/Gitee/bus/net/socket/app/tcp/tcp_client.c' property='og:url'>
<meta content='https://gitee.com/static/images/logo_themecolor.png' itemprop='image' property='og:image'>
<meta content='bus/net/socket/app/tcp/tcp_client.c · BiscuitOS/HardStack - Gitee.com' itemprop='name' property='og:title'>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function(event) {
    ...
    wx.config({
      ...
      timestamp: "1666930371",
      nonceStr: "20b510e4a9a6bb96f714c14b2eacd2cd",
      signature: "abed4fe1dd3d9389a09a461e984c216c782530fe",
      jsApiList: [
        'onMenuShareTimeline',
    ...
    wx.ready(function () {
      wx.onMenuShareTimeline({
        title: title, // 分享标题
        link: "https://gitee.com/BiscuitOS_team/HardStack/blob/Gitee/bus/net/socket/app/tcp/tcp_client.c", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        imgUrl: imgUrl // 分享图标
      });
...
<script>
  ...
  var title_form_authenticity_token = "FPuYbWVG+JSMze8itl3BcTAAMF+rOKT/7Nftz+/CXh6PwzjWQFTuUZOdl8XhZcopGqexblCAC3AwQkeE2zH7pQ==";
...
<script>
  ...
  if (false) {
    gon.project_new_blob_path = "/BiscuitOS_team/HardStack/new/Gitee/bus/net/socket/app/tcp/tcp_client.c"
    bindShowModal({
...
<input type="hidden" name="path" id="path" value="bus/net/socket/app/tcp/tcp_client.c" />
...
<i class='iconfont icon-clone' data-clipboard-text='bus/net/socket/app/tcp/tcp_client.c' id='btn-copy-file-path'></i>
</div>
<style>
  #btn-copy-file-path {
...
<span class='file_name' title='tcp_client.c'>
tcp_client.c
</span>
<small>948 Bytes</small>
</div>
...
<a class="ui button edit-blob" title="只有登陆后才可以编辑" href="/BiscuitOS_team/HardStack/edit/Gitee/bus/net/socket/app/tcp/tcp_client.c">编辑</a>
<a class="ui button web-ide" target="_blank" href="/-/ide/project/BiscuitOS_team/HardStack/edit/Gitee/-/bus/net/socket/app/tcp/tcp_client.c">Web IDE</a>
<a class="ui button edit-raw" target="_blank" href="/BiscuitOS_team/HardStack/raw/Gitee/bus/net/socket/app/tcp/tcp_client.c">原始数据</a>
<a class="ui button edit-blame" href="/BiscuitOS_team/HardStack/blame/Gitee/bus/net/socket/app/tcp/tcp_client.c">按行查看</a>
<a class="ui button edit-history" href="/BiscuitOS_team/HardStack/commits/Gitee/bus/net/socket/app/tcp/tcp_client.c">历史</a>
</div>
<script>
  "use strict";
  try {
...
<div class='line-numbers'><a href='#L1' id='L1'>1</a><a href='#L2' id='L2'>2</a><a href='#L3' id='L3'>3</a><a href='#L4' id='L4'>4</a><a href='#L5' id='L5'>5</a><a href='#L6' id='L6'>6</a><a href='#L7' id='L7'>7</a><a href='#L8' id='L8'>8</a><a href='#L9' id='L9'>9</a><a href='#L10' id='L10'>10</a><a href='#L11' id='L11'>11</a><a href='#L12' id='L12'>12</a><a href='#L13' id='L13'>13</a><a href='#L14' id='L14'>14</a><a href='#L15' id='L15'>15</a><a href='#L16' id='L16'>16</a><a href='#L17' id='L17'>17</a><a href='#L18' id='L18'>18</a><a href='#L19' id='L19'>19</a><a href='#L20' id='L20'>20</a><a href='#L21' id='L21'>21</a><a href='#L22' id='L22'>22</a><a href='#L23' id='L23'>23</a><a href='#L24' id='L24'>24</a><a href='#L25' id='L25'>25</a><a href='#L26' id='L26'>26</a><a href='#L27' id='L27'>27</a><a href='#L28' id='L28'>28</a><a href='#L29' id='L29'>29</a><a href='#L30' id='L30'>30</a><a href='#L31' id='L31'>31</a><a href='#L32' id='L32'>32</a><a href='#L33' id='L33'>33</a><a href='#L34' id='L34'>34</a></div><div class="highlight markdown-code-block"><pre class=""><div class='line' id='LC1'><span class="cp">#include</span> <span class="cpf">&lt;stdio.h&gt;</span>&#x000A;</div><div class='line' id='LC2'><span class="cp">#include</span> <span class="cpf">&lt;unistd.h&gt;</span>&#x000A;</div><div class='line' id='LC3'><span class="cp">#include</span> <span class="cpf">&lt;sys/types.h&gt;</span><span class="c1">			/* See NOTES */</span>&#x000A;</div><div class='line' id='LC4'><span class="cp">#include</span> <span class="cpf">&lt;sys/socket.h&gt;</span>&#x000A;</div><div class='line' id='LC5'><span class="cp">#include</span> <span class="cpf">&lt;arpa/inet.h&gt;</span>&#x000A;</div><div class='line' id='LC6'><span class="cp">#include</span> <span class="cpf">&lt;string.h&gt;</span>&#x000A;</div><div class='line' id='LC7'><span class="cp">#include</span> <span class="cpf">&lt;netinet/in.h&gt;</span>&#x000A;</div><div class='line' id='LC8'><span class="cp">#include</span> <span class="cpf">&lt;stdlib.h&gt;</span>&#x000A;</div><div class='line' id='LC9'><span class="cp">#include</span> <span class="cpf">&lt;errno.h&gt;</span>&#x000A;</div><div class='line' id='LC10'>&#x000A;</div><div class='line' id='LC11'><span class="kt">int</span> <span class="nf">main</span><span class="p">(</span><span class="kt">void</span><span class="p">)</span>&#x000A;</div><div class='line' id='LC12'><span class="p">{</span>&#x000A;</div><div class='line' id='LC13'>    <span class="kt">int</span> <span class="n">sock</span><span class="p">;</span>	&#x000A;</div><div class='line' id='LC14'>    <span class="kt">int</span> <span class="n">server_len</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC15'>    <span class="kt">char</span> <span class="n">sendbuf</span><span class="p">[</span><span class="mi">1024</span><span class="p">]</span><span class="o">=</span><span class="p">{</span><span class="mi">0</span><span class="p">};</span>&#x000A;</div><div class='line' id='LC16'>    <span class="kt">char</span> <span class="n">recvbuf</span><span class="p">[</span><span class="mi">1024</span><span class="p">]</span><span class="o">=</span><span class="p">{</span><span class="mi">0</span><span class="p">};</span>&#x000A;</div><div class='line' id='LC17'>    <span class="k">struct</span> <span class="n">sockaddr_in</span> <span class="n">server_address</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC18'>	&#x000A;</div><div class='line' id='LC19'>    <span class="n">sock</span> <span class="o">=</span> <span class="n">socket</span><span class="p">(</span><span class="n">PF_INET</span><span class="p">,</span> <span class="n">SOCK_STREAM</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC20'>    <span class="n">server_address</span><span class="p">.</span><span class="n">sin_family</span> <span class="o">=</span> <span class="n">AF_INET</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC21'>    <span class="n">server_address</span><span class="p">.</span><span class="n">sin_addr</span><span class="p">.</span><span class="n">s_addr</span> <span class="o">=</span> <span class="n">inet_addr</span><span class="p">(</span><span class="s">"172.16.132.97"</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC22'>    <span class="n">server_address</span><span class="p">.</span><span class="n">sin_port</span> <span class="o">=</span> <span class="n">htons</span><span class="p">(</span><span class="mi">12345</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC23'>    <span class="n">connect</span><span class="p">(</span><span class="n">sock</span><span class="p">,</span> <span class="p">(</span><span class="k">struct</span> <span class="n">sockaddr</span><span class="o">*</span><span class="p">)</span><span class="o">&amp;</span><span class="n">server_address</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">server_address</span><span class="p">));</span>&#x000A;</div><div class='line' id='LC24'>&#x000A;</div><div class='line' id='LC25'>    <span class="k">while</span><span class="p">(</span><span class="n">fgets</span><span class="p">(</span><span class="n">sendbuf</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">sendbuf</span><span class="p">),</span> <span class="n">stdin</span><span class="p">)</span> <span class="o">!=</span> <span class="nb">NULL</span><span class="p">)</span> <span class="p">{</span>&#x000A;</div><div class='line' id='LC26'>        <span class="n">write</span><span class="p">(</span><span class="n">sock</span><span class="p">,</span> <span class="n">sendbuf</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">sendbuf</span><span class="p">));</span>&#x000A;</div><div class='line' id='LC27'>        <span class="n">read</span><span class="p">(</span><span class="n">sock</span><span class="p">,</span> <span class="n">recvbuf</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">recvbuf</span><span class="p">));</span>&#x000A;</div><div class='line' id='LC28'>        <span class="n">fputs</span><span class="p">(</span><span class="n">recvbuf</span><span class="p">,</span> <span class="n">stdout</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC29'>        <span class="n">memset</span><span class="p">(</span><span class="n">sendbuf</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">sendbuf</span><span class="p">));</span>	&#x000A;</div><div class='line' id='LC30'>        <span class="n">memset</span><span class="p">(</span><span class="n">recvbuf</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="k">sizeof</span><span class="p">(</span><span class="n">recvbuf</span><span class="p">));</span>&#x000A;</div><div class='line' id='LC31'>    <span class="p">}</span>&#x000A;</div><div class='line' id='LC32'>    <span class="n">close</span><span class="p">(</span><span class="n">sock</span><span class="p">);</span>&#x000A;</div><div class='line' id='LC33'>    <span class="k">return</span> <span class="mi">0</span><span class="p">;</span>&#x000A;</div><div class='line' id='LC34'><span class="p">}</span>&#x000A;</div></pre><div class="markdown-code-block-copy-btn"></div></div></div>
</div>
<script>
